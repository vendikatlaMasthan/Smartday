...
export const SKINS: Record<SkinType, SkinPalette> = {
  // 1) SKIN A — EMBER (Shot 1)
  // Calendar + Timer: full-bleed red-orange -> tangerine -> gold gradient.
  // HOME: BLUE-to-cyan greeting screen with black glass Sessions cards.
  ember: {
    id: 'ember',
    name: 'Ember',
    tagline: 'Time Tracking & Radiant Gradients',
    primary: '#F97316', // Tangerine Orange
    accent: '#0284C7',  // Sky Blue
    background: '#091322', // Deep night blue for home
    surface: 'rgba(15, 23, 42, 0.85)', // Black glass card
    surfaceSubtle: 'rgba(255, 255, 255, 0.12)',
    cardRadius: 28,
    ink: '#FFFFFF',
    inkMuted: 'rgba(255, 255, 255, 0.65)',
    inkLight: 'rgba(255, 255, 255, 0.45)',
    ...
    colors: {
      ...
      primarySurface: 'rgba(249, 115, 22, 0.18)',
      gold: '#F59E0B',
      green: '#10B981',
      purple: '#8B5CF6',
    },
    ...
    heroGradient: ['#0A192F', '#1E3A8A', '#0284C7'],
    calendarGradient: ['#7C2D12', '#C2410C', '#EA580C', '#F59E0B'],
    timerGradient: ['#9A3412', '#EA580C', '#F97316', '#FBBF24'],
    badgeColors: {
      urgent: '#EA580C',
      medium: '#F59E0B',
