...
export const getMiaSeedData = (): SeedDataResult => {
  ...
  // 2. Tasks (including the 3 planned for today and historical completed tasks)
  const tasks: Task[] = [
    // Today's 3 tasks matching shot 1, shot 2, and shot 3
    {
      id: 'task-today-1',
      title: 'Meeting with the team',
      notes: 'Weekly architecture alignment & Q3 review',
      priority: 'High',
      estimateMin: 90,
      actualMin: 90,
      due: todayStr,
    ...
    },
    {
      ...
      notes: 'Complete hi-fi prototype for mobile productivity dashboard',
      priority: 'High',
      estimateMin: 120,
      actualMin: 60,
      due: todayStr,
    ...
    {
      id: 'task-today-3',
      title: 'Check fruit for insect & field report',
      notes: 'Review botanical test specimens in greenhouse section B',
      priority: 'Med',
      estimateMin: 45,
      due: todayStr,
      time: '14:30',
